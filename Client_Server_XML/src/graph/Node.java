...
public class Node
{
	...
	/**
	 * Makes a deep copy of this node walking all its children and establishing
	...
	/**
	 * Helper method to walk the graph. It doesn't handle cycles It uses
	 * recursion to walk the graph
	 * 
	 * @param n
	 *            Starting node
	 * @param map
	...
	private void dumpWalk(Node n, int indent)
	{
		...
		String msg = String.format("%sNode %d - %s", space, n.m_data,
				n.toString());
